...
def mae_vit_vtiny_patch16_dec128d2b(**kwargs):
    model = MaskedAutoencoderViT(
        patch_size=16, embed_dim=124, depth=12, num_heads=6,
        decoder_embed_dim=128, decoder_depth=2, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model

def mae_vit_vtiny_patch16_dec512d2b(**kwargs):
    model = MaskedAutoencoderViT(
        patch_size=16, embed_dim=124, depth=12, num_heads=6,
...
def mae_vit_vtiny_patch16_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT(
...
def mae_vit_tiny_patch16_dec128d2b(**kwargs):
    model = MaskedAutoencoderViT(
